...
exports.getAllNewArrivalsProducts = () => {
	return knex('products')
		...
		.then(response => successResponse(response, 'Success Get Products New Arrivals', 200))
		.catch(err => errorResponse(err, 500))
}
...
exports.getAllNewArrivalsProductsLogged = (id) => {
	return knex('products')
		...
		.then(response => successResponse(response, 'Success Get Products New Arrivals Logged', 200))
		.catch(err => console.log(err))
}
